...
- Look through the [open issues](https://github.com/aragon/aragen/issues). Provide workarounds, ask for clarification, or suggest labels.
- If you find an issue you would like to fix, [open a pull request](#your-first-code-contribution). Issues tagged as [_Good first issue_](https://github.com/aragon/aragen/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22) are a good place to get started.
- Take a look at the [features requested](https://github.com/aragon/aragen/labels/enhancement) by others in the community and consider opening a pull request if you see something you want to work on.

Contributions are very welcome.

### Reporting new issues

When [opening a new issue](https://github.com/aragon/aragen/issues/new/choose), always make sure to fill out the issue template. **This step is very important!**
...
You can browse our [issue tracker](https://github.com/aragon/aragen/issues) and choose an issue to fix. The development process follows one typical of open source contributions. Here's a quick rundown:

1. [Find an issue](https://github.com/aragon/aragen/issues) that you are interested in addressing or a feature that you would like to add.
...
3. Clone the repository to your local machine using `git clone https://github.com/github-username/aragen.git`.
...
- [Good first issue](https://github.com/aragon/aragen/labels/%3Apray%3A%20good%20first%20issue) - issues which should only require a few lines of code, and a test or two.
